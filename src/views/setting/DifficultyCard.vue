            ...
            <CardHeader class="pb-4">
                <CardTitle class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <span class="text-xl font-semibold">铺面标签状况</span>
                        </div>
                    </div>
                </CardTitle>
                <CardDescription>
            ...
            <CardContent class="space-y-6">
                ...
                <div v-if="AnalysisResult != undefined && AnalysisResult.length !== 0" class="space-y-3">
                    ...
                    <div
                        ...
                        <DiffTagInfoBar :tag-info="AnalysisResult" />
                    </div>
                </div>
                ...
                <div v-if="AnalysisResult !== undefined && AnalysisResult.length === 0"
                    ...
                    <Tag class="h-12 w-12 mx-auto mb-4 text-gray-300 dark:text-gray-600" />
...
import { ref } from 'vue'
import DiffTagInfoBar from '@/components/DiffTagInfoBar.vue'
...
const AdvanceFilterForm = ref<AdvanceFilterFiltersForTag>({
    ...
    Type: [],
    showUnplayed: false,
    achievement_range: [100, 101]//默认只需要鸟以上的成绩
})
...
const onAnalysis = async () => {
    ...
    try {
        ...
        AdvanceFilterForm.value.achievement_range = [100, 101]//确保不被重置影响
